...
//Display new min max field after the user guesses part one right
function showNewForm() {
  if (guessNum() === ranNum) {
    document.querySelector('#range-input').classList.add('range-form--showing');
    document.querySelector('#range-input').classList.remove('range-form');
  }
}
document.querySelector("#guess-button").addEventListener('click', showNewForm, false);
